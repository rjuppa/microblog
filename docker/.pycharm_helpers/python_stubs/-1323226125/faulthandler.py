...
def register(signum, file=None, all_threads=True, chain=False): # real signature unknown; restored from __doc__
    """ register(signum, file=sys.stderr, all_threads=True, chain=False): register an handler for the signal 'signum': dump the traceback of the current thread, or of all threads if all_threads is True, into file """
    pass
...
def _sigbus(): # real signature unknown; restored from __doc__
...
def _sigill(): # real signature unknown; restored from __doc__
